...
public class OresGroup1 {
  ...
  public static void registryOresGroup1() {
		...
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "steel_ore"), STEEL_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "steel_ore"), new BlockItem(STEEL_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "tin_ore"), TIN_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "tin_ore"), new BlockItem(TIN_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "aluminum_ore"), ALUMINUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "aluminum_ore"), new BlockItem(ALUMINUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "titanium_ore"), TITANIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "titanium_ore"), new BlockItem(TITANIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "bismuth_ore"), BISMUTH_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "bismuth_ore"), new BlockItem(BISMUTH_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "silver_ore"), SILVER_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "silver_ore"), new BlockItem(SILVER_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "cadmium_ore"), CADMIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "cadmium_ore"), new BlockItem(CADMIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "cooper_ore"), COOPER_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "cooper_ore"), new BlockItem(COOPER_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "cobalt_ore"), COBALT_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "cobalt_ore"), new BlockItem(COBALT_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "chrome_ore"), CHROME_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "chrome_ore"), new BlockItem(CHROME_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "iridium_ore"), IRIDIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "iridium_ore"), new BlockItem(IRIDIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "osmium_ore"), OSMIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "osmium_ore"), new BlockItem(OSMIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "nickel_ore"), NICKEL_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "nickel_ore"), new BlockItem(NICKEL_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "lead_ore"), LEAD_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "lead_ore"), new BlockItem(LEAD_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "thallium_ore"), THALLIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "thallium_ore"), new BlockItem(THALLIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "indian_ore"), INDIAN_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "indian_ore"), new BlockItem(INDIAN_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "bronze_ore"), BRONZE_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "bronze_ore"), new BlockItem(BRONZE_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "brass_ore"), BRASS_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "brass_ore"), new BlockItem(BRASS_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "invar_ore"), INVAR_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "invar_ore"), new BlockItem(INVAR_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "tombac_ore"), TOMBAC_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "tombac_ore"), new BlockItem(TOMBAC_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "nichrome_ore"), NICHROME_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "nichrome_ore"), new BlockItem(NICHROME_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "electron_ore"), ELECTRON_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "electron_ore"), new BlockItem(ELECTRON_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "vibranium_ore"), VIBRANIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "vibranium_ore"), new BlockItem(VIBRANIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));
		Registry.register(Registry.BLOCK, new Identifier(InquiryMod.MOD_ID, "adamantium_ore"), ADAMANTIUM_ORE);
		Registry.register(Registry.ITEM, new Identifier(InquiryMod.MOD_ID, "adamantium_ore"), new BlockItem(ADAMANTIUM_ORE, new Item.Settings().group(InquiryMod.ORES)));

		RegistryKey<ConfiguredFeature<?, ?>> steelOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "steel_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> tinOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "tin_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> aluminumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "aluminum_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> titaniumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "titanium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> bismuthOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "bismuth_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> silverOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "silver_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> cadmiumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "cadmium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> cooperOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "cooper_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> cobaltOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "cobalt_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> chromeOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "chrome_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> iridiumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "iridium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> osmiumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "osmium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> nickelOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "nickel_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> leadOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "lead_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> thalliumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "thallium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> indianOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "indian_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> vibraniumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "vibranium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> adamantiumOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "adamantium_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> bronzeOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "bronze_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> brassOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "brass_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> invarOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "invar_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> tombacOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "tombac_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> nichromeOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "nichrome_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> electronOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier(InquiryMod.MOD_ID, "electron_ore_overworld"));
