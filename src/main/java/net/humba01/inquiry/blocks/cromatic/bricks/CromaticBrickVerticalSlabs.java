...
public class CromaticBrickVerticalSlabs {
  ...
  //Mixed Brick Vertical Slabs
  public static final Block MIXED_BROWN_BRICK_VERTICAL_SLAB = new Block(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE));
  ...
  public static void registryMixedBrickVerticalSlabs() {}
