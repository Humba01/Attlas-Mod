...
public class CromaticWoolSlabs {
  ...
  //Mixed Wool Slabs
  public static final Block MIXED_BROWN_WOOL_SLAB = new Block(FabricBlockSettings.of(Material.WOOL).sounds(BlockSoundGroup.WOOL));
  ...
  public static void registryMixedWoolSlabs() {}
