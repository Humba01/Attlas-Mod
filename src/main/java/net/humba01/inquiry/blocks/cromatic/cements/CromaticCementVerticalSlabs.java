...
public class CromaticCementVerticalSlabs extends ConcretePowderBlock {
  
  public CromaticCementVerticalSlabs(Block hardened, Settings settings) {
  ...
  //Mixed Cement Vertical Slabs
  public static final Block MIXED_BROWN_CEMENT_VERTICAL_SLAB = new Block(FabricBlockSettings.of(Material.GOURD).sounds(BlockSoundGroup.SAND));
  ...
  public static void registryMixedCementVerticalSlabs() {}
