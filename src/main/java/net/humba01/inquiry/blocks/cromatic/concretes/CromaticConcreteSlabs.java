...
public class CromaticConcreteSlabs {
  ...
  //Mixed Concrete Slabs
  public static final Block MIXED_BROWN_CONCRETE_SLAB = new Block(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE));
  ...
  public static void registryMixedConcreteSlabs() {}
