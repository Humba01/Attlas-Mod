...
public class Sticks {
  ...
  /* Sticks */
    ...
    public final static Item BISMUTH_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item SILVER_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item COOPER_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item CHROME_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item IRIDIUM_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item OSMIUM_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item NICKEL_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item LEAD_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item THALLIUM_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item INDIAN_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item BRONZE_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item BRASS_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item INVAR_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item TOMBAC_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item ELECTRON_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
    public final static Item NICHROME_STICK = new Item(new FabricItemSettings().group(AttlasMod.STICKS));
...
/*
    ...
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "chrome_stick"), CHROME_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "iridium_stick"), IRIDIUM_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "osmium_stick"), OSMIUM_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "nickel_stick"), NICKEL_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "lead_stick"), LEAD_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "thallium_stick"), THALLIUM_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "indian_stick"), INDIAN_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "bronze_stick"), BRONZE_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "brass_stick"), BRASS_STICK);
    Registry.register(Registry.ITEM, new Identifier(AttlasMod.MOD_ID, "invar_stick"), INVAR_STICK);
